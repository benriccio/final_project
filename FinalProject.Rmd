...
It was expected that there would be a significant relationship between the bird and salmon populations. A similar study found "salmon biomass has a stronger relationship with bird density and diversity across watersheds than forest composition or watershed size" @wagner2019study. In this study, the influence of salmon spawning biomass on bird populations was tested using hierarchical partitioning and Akaike’s Information Criterion (AICs). This study modeled individual contribution of five forest habitat covariables on each bird response and took the top  ranked habitat variales to in the final model. The final model was created using seven models for each bird response variable, using the unique forest habitat covariate retained in the initial model selection process.Then models were fit to describe bird communities as a function of salmon biomass, forest habitat, and watershed size with site and point as random factors in all models accounting for repeated measures along spatial autocorrelation. Then multicollinearity was tested for. Variance structures of residuals were examined. Then models were averaged to obtain weighted parameter estimates for highly competitive models (ΔAICc < 2) using the natural method. Individual coefficients were then standardized to allow comparison of effect sizes across variables so a conclusion could be reached. This study found that streams that had  higher salmon biomass also had a greater relative abundance of all birds detected. This is what was expected out of our study. 
<br>
